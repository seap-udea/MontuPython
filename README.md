...
- **Code snippets** Runnable examples — one MontuPython feature per snippet, each with a short explanation. Covers utilities, time and calendars, observers, stars, Sun/Moon/planets, seasons, sky maps, heliacal rises, solar eclipses, and planetary stations. A good first overview before the topic-specific notebooks below.
