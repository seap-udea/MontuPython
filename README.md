...
> **NOTE:** A `Google Colab` notebook with some basic commands are available [here](https://colab.research.google.com/drive/1AbvT5u3yf40UPV9QldbsroeG2teUo52p?usp=sharing).
...
```
 ...
 <p align="center"><img src="https://github.com/seap-udea/MontuPython/blob/main/dev/gallery/aldebaran_over_mut.png?raw=true" alt="Logo""/></p>  
